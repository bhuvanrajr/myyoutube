  ...
  return (
    <div className='grid grid-flow-col m-2 p-2'>
        ...
        <div className='flex col-span-10 px-40'>
            ...
            indent-3 focus:outline-none focus:border-gray-400 block rounded-md sm:text-sm" value="Search" type="text"></input>
            <button className='border border-gray-400 rounded-r-full w-10'>
              <img className='h-5 mx-2' alt='logo' src={SearchIcn}/>
            </button>
        </div>
